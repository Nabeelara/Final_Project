...
const Subheading = tw.h2`text-2xl mt-4 text-center text-orange-500`;
const Description = tw.p`text-lg text-center mt-4 text-gray-800 max-w-3xl mx-auto font-medium`;
...
const PlanTitle = tw.h3`text-xl font-semibold text-pink-600`;
const PlanDescription = tw.p`text-base text-gray-700 mt-2`;
...
const FuturePlans = () => {
  ...
  return (
    <Container>
      ...
      <Description>
        At [Your Candy Shop], we believe in the magic of candy and the joy it brings. We’re always innovating and looking ahead. Here are some of our upcoming plans that we can’t wait to share with you!
      </Description>
